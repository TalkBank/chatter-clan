...
Inherited general flags: same as [FREQ](./freq.md#general--flags-freq-inherits-from-cuttcppmainusage). chatter's `Complexity` clap struct uses the standard `CommonAnalysisArgs`. Audit summary: 6 Done / 1 Partial / 4 Rewriter only / 3 Missing.
