...
**Status:** Current
**Last updated:** 2026-05-31 13:09 EDT
...
(Note: the legacy CLAN _library_ paths used by `database_integration.rs` follow a different resolver, `CLAN_SOURCE_DIR` env var → sibling `OSX-CLAN/` checkout → `~/OSX-CLAN/`. That is unrelated to the golden-test bin lookup.)
